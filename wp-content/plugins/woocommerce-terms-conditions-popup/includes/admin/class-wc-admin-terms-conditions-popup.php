...
class WC_Admin_Terms_Conditions_Popup {
    ...
    public function checkout_settings( $settings ) {
        ...
        $new_settings[] = array(
            ...
            'desc'          => __( 'Add "Agree" button', 'woocommerce-terms-conditions-popup' ),
            'id'            => 'wc_tcp_agree_button',
            'default'       => 'no',
            'type'          => 'checkbox',
            'desc_tip'		=>  __( 'This forces the user to scroll to the bottom of the popup to press an "Agree" button.', 'woocommerce' ),
            'autoload'      => false
        );
