...
<div <?php post_class( $classes ); ?>>
	...
	<div class="hb-woo-image-wrap" style="display: none;">
	...
	<div class="hb-product-meta-wrapper custom-btns clearfix">
	<div class="hb-product-meta">

		<div class="hb-woo-product-details">
			<a href="<?php the_permalink(); ?>" class="hb-woo-main-link">
				<span class="hb-woo-title"><?php the_title(); ?></span>
