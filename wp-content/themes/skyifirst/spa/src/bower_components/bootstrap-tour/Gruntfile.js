    ...
    grunt.initConfig({
      ...
      concat: {
        ...
        standalone: {
          ...
          src: ["bower_components/bootstrap/js/transition.js", "bower_components/bootstrap/js/tooltip.js", "bower_components/bootstrap/js/popover.js", "build/js/<%= pkg.name %>.js"],
      ...
      jasmine: {
        options: {
          keepRunner: true,
          vendor: ["docs/assets/vendor/jquery.js", "bower_components/bootstrap/dist/js/bootstrap.min.js"],
