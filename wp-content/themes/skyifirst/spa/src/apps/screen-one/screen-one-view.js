...
define(['extm', 'marionette'], function(Extm, Marionette) {
  var BuildingView, ScreenOneLayout, UnitTypeChildView, UnitTypeView, UnitView, UnitViewChildView, cloneunitVariantArrayColl, count, entrancetagsArray, firstElement, globalUnitArrayInt, m, object, rangeArray, tagsArray, terracetagsArray, unitVariantArray, unitVariantIdArray, unitVariantString, unitVariants, viewtagsArray;
  m = "";
  unitVariantArray = '';
  unitVariantIdArray = [];
  unitVariantString = '';
  ...
  ScreenOneLayout = (function(_super) {
    ...
    ScreenOneLayout.prototype.events = {
      ...
      'click #screen-one-button': function(e) {
        App.unit['name'] = "";
    ...
    ScreenOneLayout.prototype.showHighlightedTowers = function() {
    ...
    ScreenOneLayout.prototype.onShow = function() {
      ...
      $('#printmapplic1').text("");
      $('#towerview').text("");
      $('#screen-one-button').on('click', function() {
    ...
    ScreenOneLayout.prototype.showMsg = function() {
      $('#filtermsg').show();
    ...
    ScreenOneLayout.prototype.doListing = function() {
    ...
    ScreenOneLayout.prototype.doViewListing = function() {
    ...
    ScreenOneLayout.prototype.doentranceListing = function() {
    ...
    ScreenOneLayout.prototype.doterraceListing = function() {
    ...
    ScreenOneLayout.prototype.delItem = function(delnum) {
    ...
    ScreenOneLayout.prototype.delViewItem = function(delnum) {
    ...
    ScreenOneLayout.prototype.delEntranceItem = function(delnum) {
    ...
    ScreenOneLayout.prototype.delTerraceItem = function(delnum) {
