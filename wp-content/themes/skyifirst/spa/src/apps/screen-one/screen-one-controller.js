...
define(['extm', 'src/apps/screen-one/screen-one-view'], function(Extm, ScreenOneView) {
  var ScreenOneController, tagsArray;
  tagsArray = "";
  ScreenOneController = (function(_super) {
    ...
    ScreenOneController.prototype.initialize = function() {
      ...
      this.layout = new ScreenOneView.ScreenOneLayout({
    ...
    ScreenOneController.prototype.showUpdateBuildings = function() {
      this.Collection = this._getUnitsCountCollection();
      this.layout = new ScreenOneView.ScreenOneLayout({
        collection: this.Collection[1],
        buildingColl: this.Collection[0],
    ...
    ScreenOneController.prototype.showUpdateBuilding = function(id) {
    ...
    ScreenOneController.prototype.showViews = function() {
    ...
    ScreenOneController.prototype.showBuildingRegion = function(buildingCollection) {
      var itemview1;
      itemview1 = this.getView(buildingCollection);
      return this.layout.buildingRegion.show(itemview1);
    };

    ScreenOneController.prototype.showUnitRegion = function(unitCollection) {
      var itemview2;
      itemview2 = this.getUnitsView(unitCollection);
      return this.layout.unitRegion.show(itemview2);
    };

    ScreenOneController.prototype.getView = function(buildingCollection) {
      return new ScreenOneView.UnitTypeChildView({
        collection: buildingCollection
      });
    };

    ScreenOneController.prototype.getUnitsView = function(unitCollection) {
      return new ScreenOneView.UnitTypeView({
        collection: unitCollection
      });
    };

    ScreenOneController.prototype._unitCountSelected = function() {
      return App.navigate("screen-two", {
        trigger: true
      });
    };

    ScreenOneController.prototype._getUnitsCountCollection = function(paramid) {
