  ...
  return App.module("SettingsView.Views", function(Views, App) {
    return Views.List = (function(_super) {
      ...
      List.prototype.onShowExpiryData = function() {
        ...
        this.$el.find("#save_settings").attr('disabled', false);
        this.$el.find("#settingsmsg").before('<div class="alert alert-success"> <button data-dismiss="alert" class="close"></button> Your changes have been saved</div>');
